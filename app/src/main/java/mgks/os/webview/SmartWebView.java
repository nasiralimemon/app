...
class SmartWebView {
	...
	static boolean ASWP_ONLYCAM = true;        // incase you want only camera files to upload
	...
	// URL configs
	static String ASWV_URL = "https://www.dforce.pk/stores_login.php";     // complete URL of your website or offline webpage
